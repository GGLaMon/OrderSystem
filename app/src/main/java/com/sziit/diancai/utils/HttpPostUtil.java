...
public class HttpPostUtil {
    ...
    // 请求服务器端的url
    public static String BASE_PATH = "http://139.199.220.137";
    public static String PHOTO_PATH=BASE_PATH+"/Order/images/";
    public static String PATH = BASE_PATH + "/Order/Main/";
    ...
    public static void setBaseUrl(String ip, String port) {
        ...
        // 如果端口号为空
        if (port.equals("")) {
            PATH = "http://" + ip + "/Order/Main/";
            // 如果端口号不为空
        } else {
            PATH = "http://" + ip + ":" + port + "/Order/Main/";
        }
        // 更新全部的URL
